import {resolveLocale,languageInstruction,greetingInstruction} from './locale.mjs';
...
export function sessionConfig(context,locale=resolveLocale()){return {
 ...
 audio:{input:{format:{type:'audio/pcm',rate:24000},transcription:{model:'gpt-4o-transcribe'},turn_detection:null},output:{format:{type:'audio/pcm',rate:24000},voice:'cedar',speed:0.95}},
